...
export function checkInput(input, e) {
    ...
    if (input.name === "message") {
        ...
        validity.isValid = !input.validity.valueMissing && !input.validity.tooShort && !input.validity.tooLong;
        validity.error = input.validity.valueMissing ? "This field is required.": 
            input.validity.tooShort || input.validity.tooLong ? "Must be a valid phone number." : "";
        return validity;
